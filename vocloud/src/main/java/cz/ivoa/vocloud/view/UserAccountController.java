...
import cz.ivoa.vocloud.view.util.JsfUtil;
import cz.ivoa.vocloud.view.util.PaginationHelper;
...
public class UserAccountController implements Serializable {
    ...
    private static final ResourceBundle bundle = ResourceBundle.getBundle("/cz/ivoa/vocloud/Bundle");
