...
import cz.ivoa.vocloud.spark.schema.UwsSettings;
 ...
 * @author radiokoza
 */
@WebServlet(name = "uws-spark", urlPatterns = {"/uws/*"})
public class UWS extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        if (settings == null) {
            //load default
            try {
                JAXBContext jxb = JAXBContext.newInstance("cz.ivoa.vocloud.spark.schema");
        ...
        if (uws == null) {
            ...
            try {
                ...
                // setup execution duration controller (4 days)
                uws.getExecutionDurationController().setDefaultExecutionDuration(345600);
                uws.getExecutionDurationController().setMaxExecutionDuration(345600);
